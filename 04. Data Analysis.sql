...
FROM gda-capstone-01.cyclistic23.cleaned23
...
SELECT member_casual, month, AVG(ride_length) AS avg_ride_month
FROM gda-capstone-01.cyclistic23.cleaned23
GROUP BY member_casual, month
ORDER BY member_casual, avg_ride_month;

-- Average ride_length per day of week
SELECT member_casual, day_of_week, AVG(ride_length) AS avg_ride_week
FROM gda-capstone-01.cyclistic23.cleaned23
GROUP BY member_casual, day_of_week
...
SELECT member_casual, EXTRACT(HOUR FROM started_at) AS hour_of_day, AVG(ride_length) AS avg_ride_hour
FROM gda-capstone-01.cyclistic23.cleaned23
GROUP BY member_casual, hour_of_day
